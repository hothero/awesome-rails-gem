...
* [Sequenced](https://github.com/djreimer/sequenced) - Sequenced is a simple gem that generates scoped sequential IDs for 
ActiveRecord models.
* [squeel](https://github.com/activerecord-hackery/squeel) - A DSL that allows nicer ActiveRecord queries.
